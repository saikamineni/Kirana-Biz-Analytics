complaints = LOAD './Project_DataSet-1.txt' AS (
Case:int,
Acc_Type:chararray,
Center:chararray,
...
complaints_filtered = FILTER complaints by LOB != 'LOB';

DUMP complaints_filtered;

complaints_grpByLOB = GROUP complaints_filtered BY LOB;

DUMP complaints_grpByLOB;
describe complaints_grpByLOB;

complaints_total_LOB = FOREACH complaints_grpByLOB GENERATE group, (chararray) COUNT(complaints_filtered) AS kount;

DUMP complaints_total_LOB;
